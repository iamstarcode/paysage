...
CREATE TABLE public.wallets (
    ...
    user_id uuid not null references auth.users(id), -- Reference to the user who owns the wallet
    ...
    UNIQUE(user_id, currency_code) -- Ensure each user has only one wallet per currency
);
